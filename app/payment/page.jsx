    ...
    return (
        <div className="lg:py-28 h-screen">
            ...
            <div className={`${styles.paymentParent} lg:w-[70%] h-full lg:flex-row flex flex-col-reverse  lg:overflow-hidden rounded-3xl`}>
                ...
                <div className={`${styles.cardParent} flex lg:w-1/2 h-full p-10`}>
                    <div onClick={() => setIsFlipped(!isFlipped)} className={`${styles.card} ${isFlipped ? styles.flipped : ""} lg:w-[500px] lg:h-[300px] h-60 w-96 `}>
