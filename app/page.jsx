    ...
    <div className="">
      <div className="flex flex-col bg-[#e9e6e6] w-screen">
        <div className="flex flex-col lg:flex-row rounded-3xl w-full">
          ...
          <div className="lg:w-2/6 flex flex-col justify-between lg:p-20 p-10 bg-[#50c7b3] gap-8 text-white">

            <span className="text-5xl 2xl:text-8xl">Weekend Brand Sale </span>
        ...
        <div className="bg-[#E2DBDB] grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-10 p-10">
          <div className="bg-[#e595a8] rounded-xl flex justify-center items-center  overflow-hidden">
            <img className="object-cover h-72 drop-shadow-[0_35px_35px_rgba(0,0,0,0.30)]" src="images/banner/product304.png" alt="" />

          </div>
          <div className="relative bg-[#a6bedd] rounded-xl flex justify-center items-center overflow-hidden">
            <img className="object-cover h-80 drop-shadow-[0_35px_35px_rgba(0,0,0,0.30)]" src="images/banner/product301.png" alt="" />
            <span className="absolute font-bold md:text-8xl text-6xl text-white/50">50% SALE</span>
          </div>
          <div className="bg-[#bb9de2] rounded-xl flex justify-center items-center  overflow-hidden">
            <img className="object-cover h-80 drop-shadow-[0_35px_35px_rgba(0,0,0,0.30)]" src="images/banner/product40.png" alt="" />
